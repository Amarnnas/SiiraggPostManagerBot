...
async def main():
    ...
    async def welcome(message: Message):
        if message.from_user.username not in ALLOWED_USERS:
            await message.answer("🚫 السلام عليكم ورحمة الله وبركاته يا أحباب 🌿

البوت دا خُصص لأهل سراج فقط، أهل الهمة والدعوة والتعاون على البر.
لو ظهرت ليك الرسالة دي، فمعناها إنو حسابك لسه ما مُفعّل.

نتمنى تتواصل مع الإدارة أو أحد أعضاء الفريق عشان يتم التفعيل.
